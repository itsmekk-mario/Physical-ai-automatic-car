...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen',
            parameters=[os.path.join(decision_share, 'config', 'safety_supervisor.yaml'), {'autonomy_level': 4}],
        ),
        Node(
            package='jetcar_decision',
            ...
            parameters=[
                ...
                {'autonomy_level': 4, 'enabled_on_start': True, 'require_lane': False, 'cruise_throttle': 0.07},
            ],
        ),
        Node(
