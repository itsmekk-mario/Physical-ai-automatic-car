...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen',
            parameters=[os.path.join(control_share, 'config', 'control.yaml'), {'default_mode': 'AUTONOMOUS'}],
        ),
        Node(
            package='jetcar_control',
        ...
        Node(
            ...
            output='screen',
            parameters=[os.path.join(decision_share, 'config', 'safety_supervisor.yaml'), {'autonomy_level': 3}],
        ),
        Node(
            package='jetcar_decision',
            ...
            parameters=[
                ...
                {'autonomy_level': 3, 'enabled_on_start': True, 'require_lane': False, 'cruise_throttle': 0.07},
            ],
        ),
        Node(
        ...
        Node(
            ...
            respawn=True,
            respawn_delay=2.0,
            parameters=[yolo_web_config, dashboard_params],
        ),
    ])
